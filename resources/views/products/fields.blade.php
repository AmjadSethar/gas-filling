<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4">
        ...
        <div class="input-group mb-5">
            {{ Form::text('wall_type', null, ['class' => 'form-control ', 'placeholder' => __('messages.product.wall_type'), 'required', 'onkeypress' => 'return blockSpecialChar(event)']) }}
        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="input-group mb-5">
            {{ Form::text('purchase_from', null, ['class' => 'form-control ', 'placeholder' => __('messages.product.purchase_from'), 'required', 'onkeypress' => 'return blockSpecialChar(event)']) }}
        </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="input-group mb-5">
            {{ Form::text('weight', null, ['class' => 'form-control ', 'placeholder' => __('messages.product.weight'), 'required', 'onkeypress' => 'return blockSpecialChar(event)']) }}
        </div>
