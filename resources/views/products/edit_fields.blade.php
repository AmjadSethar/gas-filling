<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        {{ Form::label('wall_type', __('messages.product.wall_type').':', ['class' => 'form-label required mb-3']) }}
        <div class="input-group mb-5">
            {{ Form::text('wall_type',isset($product) ? $product->wall_type : null,['class' => 'form-control ', 'placeholder' => __('messages.product.wall_type'), 'required','onkeypress'=>"return blockSpecialChar(event)"]) }}
        </div>
    </div>
    <div class="col-lg-6">
        {{ Form::label('purchase_from', __('messages.product.purchase_from').':', ['class' => 'form-label required mb-3']) }}
        <div class="input-group mb-5">
            {{ Form::text('purchase_from',isset($product) ? $product->purchase_from : null,['class' => 'form-control ', 'placeholder' => __('messages.product.purchase_from'), 'required','onkeypress'=>"return blockSpecialChar(event)"]) }}
        </div>
    </div>
    <div class="col-lg-6">
        {{ Form::label('weight', __('messages.product.weight').':', ['class' => 'form-label required mb-3']) }}
        <div class="input-group mb-5">
            {{ Form::text('weight',isset($product) ? $product->weight : null,['class' => 'form-control ', 'placeholder' => __('messages.product.weight'), 'required','onkeypress'=>"return blockSpecialChar(event)"]) }}
        </div>
    </div>
    <div class="col-lg-6">
