...
Route::prefix('admin')->middleware(['auth', 'xss', 'role:admin'])->group(function () {
    ...
    Route::get('/invoices-excel-client/{id}', [ClientController::class, 'exportInvoicesExcel'])->name('admin.invoicesExcelCustomer');
...
Route::prefix('client')->middleware(['auth', 'xss', 'role:client'])->group(function () {
    ...
    Route::get(
        'challans',
        [Client\ChallanController::class, 'index']
    )->name('client.challan.index');
    Route::get(
        'invoices/{invoice}',
        [Client\InvoiceController::class, 'show']
    )->name('client.invoices.show');
